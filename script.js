// --- GAME CONFIGURATION ---
const WORD_LIST = ["ant","apple","ball","banana","bed","bird","book","bus","cake","car","cat","cherry","chicken","chip","clock","cloud","cow","cup","daddy","dog","fish","flag","foot","fox","frog","georgia","grandad","grandma","grandpa","hand","hat","house","ivy","jimmy","key","leaf","moon","mummy","nanna","nose","pen","pig","rainbow","sheep","shoe","slide","snowman","star","sun","swing","zebra"];
